...
import MyactivityStoryReplies from './myactivitystoryreplies/MyactivityStoryReplies';
import { Link } from 'react-router-dom';

function Myactivitystoryrepliesui() {
  return (
    <>
...
export default Myactivitystoryrepliesui