...
function Post() {
    ...
    const dropHandler=(event:any)=>console.log("file")


   
  return (
    <div className='post-continer'>
      <div className='post-nav-bar-continer'>
        <Navigationbar/>
        </div>
            <div className='post-main'>
                    <div className='post-create-new-continer'>
                        <div className='post-create-new-header'>
                            Create new post
                        </div>
                        <div className='post-drag-and-drop-continer'>
                            <div className='post-drag-and-drop-continerimage-continer'>
                            ...
                            <div className='post-drag-drop-text'>Drag Photos and videos here</div>
                            <input type="file" id="actual-btn" hidden/>
                            <label htmlFor="actual-btn">Select from computer</label>
                        </div>
                    </div>
